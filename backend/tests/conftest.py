...
_VALID_PLAN: dict = {
    ...
    "assumed_prerequisites": [
        "Account object and its standard page layout already exist.",
    ],
    "steps": [
        {
            "step_number": 1,
        ...
        {
            "step_number": 3,
            "title": "Deploy field to connected org",
            "type": "Deploy",
            "environment": "Org",
            "description": "Deploy the field metadata to the connected Dev org.",
            "lsc_guide_reference": None,
            "metadata_path": None,
            "acceptance_check": "Deployment succeeds; field present in the org.",
